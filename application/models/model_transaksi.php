...
class model_transaksi extends CI_Model
{
	...
	function laporan_periode($tanggal_1,$tanggal_2)
	{
		$query ="SELECT t.tanggal_transaksi, o.nama_lengkap, sum(td.harga*td.qty) as total
				FROM transaksi as t, transaksi_detail as td, operator as o
				WHERE td.transaksi_id=t.transaksi_id and o.operator_id=t.operator_id and 
				t.tanggal_transaksi between '$tanggal_1' and '$tanggal_2'
				group by td.transaksi_id";
		return $this->db->query($query);
	}
