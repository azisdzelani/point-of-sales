...
<table class="table table-bordered">
	...
	<td><input type="text" name="nama_barang" value="<?php echo $record['nama_barang']; ?>" class="form-control" placeholder="nama barang"></td>
	</tr>
	<tr><td>Kategori</td>
		<td>
	...
	<tr>
	<td>Harga</td>
	<td><input type="text" name="harga" value="<?php echo $record['harga'] ?>" class="form-control" placeholder="harga"></td>
	</tr>
